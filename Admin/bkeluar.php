...
<?php if(isset($_GET['pesan'])): ?>
    <?php
        $pesan = $_GET['pesan'];
        if($pesan == 'berhasil'){
            echo '<div class="alert alert-success">Barang keluar berhasil dicatat!</div>';
        } elseif($pesan == 'stok_kurang'){
            echo '<div class="alert alert-danger">Stok tidak mencukupi!</div>';
        } elseif($pesan == 'barang_tidak_ada'){
            echo '<div class="alert alert-danger">Barang tidak ditemukan!</div>';
        } else {
            echo '<div class="alert alert-danger">Terjadi kesalahan saat mencatat barang keluar!</div>';
        }
    ?>
<?php endif; ?>
  ...
  <div class="card-body">
    <form method="post" action="proses_keluar.php">
      ...
      <div class="form-group">
        ...
        <input type="text" name="keterangan" class="form-control" placeholder="misal: rusak, habis dipakai">
      </div>
