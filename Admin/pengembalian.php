...
$peminjaman = mysqli_query($conn, "SELECT p.id_peminjaman, b.nama_barang, p.jumlah_pinjam, p.tgl_pinjam 
                                   FROM peminjaman p 
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <?php if(isset($_GET['pesan'])){ ?>
      <?php if($_GET['pesan']=='berhasil'){ ?>
        <div class="alert alert-success">Pengembalian berhasil dicatat!</div>
      <?php } elseif($_GET['pesan']=='gagal'){ ?>
        <div class="alert alert-danger">Terjadi kesalahan saat mencatat pengembalian!</div>
      <?php } ?>
    <?php } ?>
            ...
            <select name="id_peminjaman" class="form-control" required>
              ...
              <?php while($p = mysqli_fetch_assoc($peminjaman)){ ?>
                <option value="<?= $p['id_peminjaman'] ?>">
                  <?= $p['nama_barang'] ?> (Jumlah: <?= $p['jumlah_pinjam'] ?>, Tgl Pinjam: <?= $p['tgl_pinjam'] ?>)
                </option>
              <?php } ?>
            </select>
          </div>
